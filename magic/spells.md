...
If an affected creature ends its turn while not within 60 feet of the target or able to see it, or the creature takes damage from or is otherwise harmed by the target, the creature can make another [😈 Resist Enchantment](../ability-scores-and-skills.md#resist-enchantment) check. On a success, the creature is no longer affected by the target and recognizes the effect as magical. In addition, each effected creature may make another [😈 Resist Enchantment](../ability-scores-and-skills.md#resist-enchantment) check every 24 hours.

A creature that succeeds a [😈 Resist Enchantment](../ability-scores-and-skills.md#resist-enchantment) check against this effect is immune to it for 1 minute, after which time it can be affected again.
...
When casting this spell with [mastery](../ability-scores-and-skills.md#mastery), you can bring along up to nine other willing creatures within 10 feet of you.
{% endhint %}
...
For the duration, you gain a number of [dominance ](../success-and-failure.md#dominance-and-threat)dice on all [💨 Evasion](../ability-scores-and-skills.md#evasion) checks equal to the number of duplicates you have. When you succeed an [💨 Evasion](../ability-scores-and-skills.md#evasion) check, one of the duplicates disappears. The spell ends early if all of the duplicates vanish.
...
When casting this spell with mastery, you gain [dominance ](../success-and-failure.md#dominance-and-threat)on [Spell Tolerance](rules-of-magic.md#spell-tolerance) checks to open magically locked objects.
{% endhint %}
...
While affected by this spell, the object is more difficult to break or force open; the [DC](../success-and-failure.md#difficulty-class) to break it or pick any locks on it increases by `+10`.
...
Choose a creature you can see within range. The target must succeed on a [🏃🏻 Resist Restraint](../ability-scores-and-skills.md#resist-restraint) check or be [😬 Paralyzed ](../reference/status-effects.md#paralyzed)for the duration. At the end of each of its turns, it can repeat this check, ending the spell's effect on it on a success.
