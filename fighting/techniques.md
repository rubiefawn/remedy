...
Target one [surprised](../encounters.md#surprise) creature, and make one weapon attack against them. If the attack hits, it does an additional `2d10 🩸`.
...
You gain `1d12+💪 💜 vs 💢🩸` and [dominance](../success-and-failure.md#dominance-and-threat) on [💨 Evasion](../ability-scores-and-skills.md#evasion) checks until the beginning of your next turn.
...
You make a false attack against one creature in range. The target must succeed on a [💭 Reasoning](../ability-scores-and-skills.md#reasoning) check. If it fails, it gains threat on all [💨 Evasion](../ability-scores-and-skills.md#evasion) checks, attack rolls, and spell rolls until the end of your next turn.
...
Make a weapon attack. If the attack hits, the target must succeed on a DC `15` [💙 Resist Death](../ability-scores-and-skills.md#resist-death) check or drop to 0 hit points.
...
Make two weapon attacks. They can target one or different creatures. If the attacks hit, they do an additional `1d4 🩸`.
...
Make one weapon attack with [dominance](../success-and-failure.md#dominance-and-threat). If the attack hits, it does an additional `1d10 🩸`.
...
Make one weapon attack. If the attack hits, the target must succeed on a [😪 Resist Exhaustion](../ability-scores-and-skills.md#resist-exhaustion) check or become [😵 Stunned](../reference/status-effects.md#stunned) for 1 minute. The target may repeat the check at the end of each of its turns, ending the effect on itself on a success.
