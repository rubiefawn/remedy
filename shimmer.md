...
Ability Scores are numeric values that represent the core capabilities of a creature.
...
1. **Roll the dice:** roll the d20(s), applying dice modifiers. See the rules on aptitude and mastery to figure out how many d20s to use.
