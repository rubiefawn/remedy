...
Mana comes in different strengths, called mana levels. Mana can have levels 1 through 9, These are unrelated to character level directly, though a character's level does determine how strong their mana is, as well as the quantity. More powerful mana can be used to cast greater spells or stronger gambits.
...
Sacrificial casting is a dangerous gamble, by which spells are fueled by the caster's own flesh and life-force. To cast a spell sacrificially, you first cast it without expending mana, and then receive an amount of wounds equal to the level of mana you are substituting for. You do not need an arcane focus when casting sacrificially.
